...
EXEC silver.load_silver_test

CREATE OR ALTER PROCEDURE silver.load_silver_test AS
BEGIN
	DECLARE @start_time DATETIME, @end_time DATETIME; 
    BEGIN TRY
	    PRINT '================================================';
		...
		PRINT '>>>>>TRUNCATING TABLE: silver.construction';
		TRUNCATE TABLE silver.construction_test;
		PRINT '>>>>>INSERTING TO TABLE: silver.construction';
		--CTE named cleaned
		WITH cleaned AS (
			SELECT
		...
		INSERT INTO silver.construction_test
		SELECT 
		*,
